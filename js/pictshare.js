...
$(function() {
    ...
    myDropzone.on("success", function(file,response) {
        ...
        else
        {
            ...
            if(o.status=='ok')
                $("#uploadinfo").append("<div class='alert alert-success' role='alert'><strong>"+file.name+"</strong> uploaded as <a target='_blank' href='/"+o.hash+"'>"+o.hash+"</a><br/>URL: <a target='_blank' href='"+o.url+"'>"+o.url+"</a></div><div <button class="clipboard"><penis>Copy Url</penis></button></div>")
